...
<head>
    ...
    <title>Tiket Bus Online | Aplikasi Pemesanan Tiket Bus</title>
    <link rel="icon" href="https://seeklogo.com/images/R/redbus-logo-13648C0E43-seeklogo.com.png">
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav>
            <div>
                <a href="#" class="nav-item nav-logo"><img src="https://seeklogo.com/images/R/redbus-logo-13648C0E43-seeklogo.com.png" width="65" alt=""></a>
            ...
            <div>
                ...
                <a href="#pnr-cari" class="pnr nav-item">Pencarian PNR</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Aplikasi Pemesanan Tiket Bus</h1>

            <p class="text-center">Selamat datang di Aplikasi Pemesanan Tiket Bus. Login untuk mengatur tiket bus dan yang lainnya. Atau, klik scroll down button untuk cek status ticket anda menggunakan Passenger Name Record (PNR number)</p>
            ...
            <br>
            <center>
                <a href="#pnr-cari"><button class="btn btn-primary">Scroll Down <i class="fa fa-arrow-down"></i></button></a>
            </center>
    ...
    <div id="block">
        ...
        <section id="pnr-cari">
            <div id="pnr-form">
                ...
                <form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="POST">
                    <div>
                        <input type="text" name="pnr" id="pnr" placeholder="Cari PNR">
                    </div>
        ...
        <section id="about">
            <div>
                ...
                <p>
                    redBus adalah platform pemesanan tiket bus online terbesar di dunia yang dipercaya oleh jutaan pelanggan dari seluruh dunia. 
                    Bersama redBus, rasakan mudahnya memesan tiket dari operator-operator bus terbaik untuk berbagai rute di Indonesia. 
                    Mulai dari bus mewah dengan segudang fasilitas hingga bus kelas ekonomi, redBus mempermudah Anda memilih bus di rute yang diinginkan hanya dengan beberapa klik. 
                    Ingin berkunjung ke Jakarta, Bandung, Surabaya, atau Bali? redBus menghubungkan rute-rute populer di Indonesia menggunakan bus! Cek harga di redBus dan pesan tiket bus secara online. Dengan promo menarik dan harga tiket bus paling bersaing, Anda bisa berhemat dengan pesan tiket bus online. 
                    Siapkan diri untuk perjalanan bus yang tak terlupakan, bersama redBus!
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
            <p>
                <i class="far fa-copyright"></i> <?php echo date('Y'); ?> - Aplikasi Pemesanan Tiket Bus | Made with &#10084;&#65039; by Danny Ferdiansyah from Ashwin Anil
            </p>
        </footer>
    </div>
